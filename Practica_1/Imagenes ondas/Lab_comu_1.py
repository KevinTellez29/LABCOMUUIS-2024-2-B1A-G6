...
class Lab_comu_1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Practica_1A.2", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Practica_1A.2")
        ...
        self._freq_range = qtgui.Range(1e3, 40e3, 1e3, 2e3, 200)
